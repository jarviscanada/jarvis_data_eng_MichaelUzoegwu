...
import ca.jrvs.apps.jdbc.example.dto.Company;
...
public class JsonParser {
   ...
   * @param prettyJson indented output
   ...
   * @throws IOException
   */
  public static <T> T toObjectFromJSON(String json, Class<T> objectClass) throws IOException {
    ObjectMapper objectMapper = new ObjectMapper();
